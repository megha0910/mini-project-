...
count_data <- read_csv('C:\\Users\\HP\\Downloads\\GSE164416_raw_counts_GRCh38.p13_NCBI.csv')
...
Type <- rep(c("Pancreatic tissue Control", "Pancreatic tissue T2D"), each = ncol(counts_data)/2)  # Adjusted condition labels
...
write.csv(res_df, "C:\\Users\\HP\\Downloads\\Pancreatic_DESeq2_results.csv", row.names = TRUE)
cat("DESeq2 results saved to 'Pancreatic_DESeq2_results.csv'\n")
write.csv(res_df, file = "C:/Users/HP/Downloads/Pancreatic_DESeq2_results.csv", row.names = TRUE)
...
head(res_df)
write.csv(res_df, "C:\\Users\\HP\\Downloads\\GSE164416_raw_counts_GRCh38.p13_NCBI.csv"/Pancreatic_DESeq2_results_with_annotations.csv", row.names = TRUE)
